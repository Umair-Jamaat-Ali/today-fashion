    ...
    return (
        ...
        <div>
            ...
            <div className="mx-auto max-w-2xl text-center">
                <h2 className="text-5xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">TOᗪᗩY ᖴᗩᔕᕼIOᑎ</h2>
                <h2 className="text-xl font-bold tracking-tight text-gray-900 sm:text-4xl">Contact Us</h2>
